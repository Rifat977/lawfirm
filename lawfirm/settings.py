...
SECRET_KEY = 'django-insecure-ceqkazuq!^f3*u2rd0*$kpl2su=^eit-z+u4pcz*&g+z5-45es'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.site_about',
            ],
        },
    },
]
...
EMAIL_HOST = 'mail.prominentlawfirm.com'  # Removed trailing space
EMAIL_PORT = 587 
EMAIL_USE_TLS = True 
EMAIL_USE_SSL = False 
